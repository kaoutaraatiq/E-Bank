...
public class BankAccountMapperImpl {
    ...
    public Customer fromCustomerDTD(CustomerDTO customerDTO){
    ...
    public SavingAccount fromSavingBankAccountDTO(SavingBankAccountDTO savingBankAccountDTO){
        ...
        savingAccount.setCustomer(fromCustomerDTD(savingBankAccountDTO.getCustomerDTO()));
    ...
    public CurrentAccount fromCurrentAccountDTO(CurrentBankAccountDTO currentBankAccountDTO){
        ...
        currentAccount.setCustomer(fromCustomerDTD(currentBankAccountDTO.getCustomerDTO()));
